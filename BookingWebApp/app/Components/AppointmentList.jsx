          ...
          <table className="w-full border-separate border-spacing-y-3 bg-gray-300 rounded-lg p-2">
            ...
            <tbody>
              {appointments?.map((element, index) => (
                <tr
                  key={index}
                  className="bg-neutral-100 rounded-2xl cursor-pointer"
                >
                  <td className="p-2 max-w-[70px] align-top text-center font-semibold">
                    <div
                  ...
                  <td className="p-2 max-w-[70px] align-top text-center">
                    <div
                      onClick={() => setSelectedAppointment(element)}
                      className="h-full text-neutral-100 p-[5px] w-full rounded-md bg-blue-500 text-xs cursor-pointer hover:bg-blue-600 transition-colors"
                    >
                      Update
                    </div>
                  </td>
            ...
            >
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => setSelectedAppointment(element)}
                    className="bg-blue-500 hover:bg-blue-600 text-neutral-100 font-semibold px-3 py-1 rounded-md text-xs transition-colors"
                  >
                    Update
                  </button>
                </div>
